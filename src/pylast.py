	...
	def _get_cache_key(self):
		...
		for key in keys:
			if key != "api_sig" and key != "api_key" and key != "sk":
				cache_key += urllib.quote_plus(key.encode('utf-8')) + urllib.quote_plus(urllib.quote_plus(self.params[key].encode('utf-8')))
...
def _get_url_safe(text):
	...
	return urllib.quote_plus(urllib.quote_plus(text.encode('utf-8'))).lower()
