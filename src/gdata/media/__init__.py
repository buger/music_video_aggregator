...
class Content(MediaBaseElement):
  ...
  def __init__(self, url=None, width=None, height=None,
      ...
      extension_elements=None, extension_attributes=None, text=None, duration = None):
...
class Resctriction(MediaBaseElement):
  """The YouTube Duration element"""
  _tag = 'restriction'
  _namespace = YOUTUBE_NAMESPACE
  _attributes = atom.AtomBase._attributes.copy()
...
class Group(MediaBaseElement):
  ...
  _children['{%s}restriction' % MEDIA_NAMESPACE] = ('restriction', Resctriction)
  ...
  def __init__(self, content=None, credit=None, description=None, keywords=None,
               ...
               extension_attributes=None, text=None, restriction = None):
