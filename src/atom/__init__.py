...
GDATA_NAMESPACE = 'http://gdata.youtube.com/schemas/2007'
...
class Control(AtomBase):
  ...
  _children['{%s}state' % GDATA_NAMESPACE] = ('state', State)

  def __init__(self, draft=None, text=None, extension_elements=None,
        extension_attributes=None, state = None):
